...
public enum XMG_AlignType {
    ...
    func layoutAttributes(isInner: Bool, isVertical: Bool) -> XMG_LayoutAttributes {
...
extension UIView {
    ...
    */
    public func xmg_HorizontalTile(views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
        ...
        for i in 1..<views.count {
            let subView = views[i]
            cons += subView.xmg_sizeConstraints(view : firstView)
    ...
    */
    ...
    :returns: 约束数组
    */
    func xmg_AlignLayout(referView: UIView, attributes: XMG_LayoutAttributes, size: CGSize?, offset: CGPoint) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    func xmg_sizeConstraints(size size: CGSize) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    func xmg_sizeConstraints(view referView: UIView) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    func xmg_positionConstraints(referView: UIView, attributes: XMG_LayoutAttributes, offset: CGPoint) -> [NSLayoutConstraint] {
...
///  布局属性
final class XMG_LayoutAttributes {
